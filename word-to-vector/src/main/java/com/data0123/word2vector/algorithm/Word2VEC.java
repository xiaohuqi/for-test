package com.data0123.word2vector.algorithm;
...
public class Word2VEC {
	...
	/**
	 *  计算语义距离
	 * @param queryWord 查询目标词
	 * @param size 输出数量，会按语义距离降序排列
	 * @return 词、距离列表
	 */
	public Set<WordEntry> distance(String queryWord, int size) {
		...
		int resultSize = wordMap.size() < size ? wordMap.size() : size;
...
//		System.out.println(c);
	 ...
	 * @return 词、距离列表
	 */
	public Set<WordEntry> distance(List<String> words, int size) {

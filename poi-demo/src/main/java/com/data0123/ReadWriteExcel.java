...
/**
 * @author xiaohuqi@126.com 2017-11-21 11:14
 **/
public class ReadWriteExcel {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter(new File("d:/work/data/InsertSql.txt")));
		try {
			// 同时支持Excel 2003、2007
			File excelFile = new File("D:\\work\\data\\810.xlsx"); // 创建文件对象

package com.data0123.fortest.segment;

import com.data0123.fortest.file.ReadFileUtil;
import com.data0123.fortest.map.MapSort;
...
//		input = new ReadFileUtil().readFileByCharSet("D:\\work\\guowang\\2017_menu.txt", "utf-8");
		input = new ReadFileUtil().readFileByCharSet("D:\\work\\guowang\\zhinan\\2017.txt", "utf-8");
...
//			System.out.println(word);
		...
		mapSort.sortMap(map, keyList, valueList);
